...
public class TaskRepositoryImpl implements TaskRepository {
    ...
    private final String FIND_BY_ID = """
            SELECT t.id              as task_id,
                   ...
                   t.expiration_date as task_expiration_date,\s
                   t.status          as task_status
            FROM tasks t
            where id = ?
            """;

    private final String FIND_ALL_USER_BY_ID = """
            SELECT t.id              as task_id,
                   t.title           as task_title,
                   t.description     as task_description,
    ...
    public List<Task> findAllByUser(Long userId) {
        try{
            Connection connection = dataSourceConfig.getConnection();
            PreparedStatement statement = connection.prepareStatement(FIND_ALL_USER_BY_ID);
    ...
    public void update(Task task) {
        try{
            ...
            throw new ResourceMappingException("Error while update to task.");
        }
    }
